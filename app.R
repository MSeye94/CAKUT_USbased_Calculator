...
ui <- fixedPage(
  ...
  fixedRow(column(5,
                  titlePanel(
                    ...
                    title = div(style="font-weight:bold;color: black;font-size: 0.6em"
                                ,"Combining 3 ultrasound observations could be used to assess in utero the postnatal kidney survival at 2 years of life of fetuses with bilateral CAKUT."),
                    
                    windowTitle = "Prediction of renal postnatal outcome"
                  ),
                  style = "background-color: hsla(0, 20%, 98%, 0.815);"
                  ),
           
           column(7,
                  div(
                    style="padding:0px; border-width:0px;display:inline-block;",
                    class="pull-right",
                    tags$img(src="rflabxx.png",width="30%")
                  )
           )),
  ...
  fixedRow(
    ...
    column(7,
           ...
           fixedRow(column(12,
                           fluidRow(br()),
                           HTML(paste(' <ol style = "list-style-type: none;font-weight:bold;color: #760001;font-size: 1.25em">
